...
public class ApplicationHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(ApplicantNotfoundByIdException.class)
	public ResponseEntity<ResponseStructure<String>> applicantNotfound(ApplicantNotfoundByIdException ex) {
		ResponseStructure<String> responseStructure = new ResponseStructure<>();
		responseStructure.setStatusCode(HttpStatus.NOT_FOUND.value());
	...
	public ResponseEntity<ResponseStructure<String>> jobNotFound(jobNotFoundByIdException ex) {
		ResponseStructure<String> responseStructure = new ResponseStructure<>();
		responseStructure.setStatusCode(HttpStatus.NOT_FOUND.value());
		responseStructure.setMessage(ex.getMessage());
